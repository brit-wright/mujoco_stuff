...
class Trajectory():
    ...
    def evaluate(self, t, dt):
        ...
        self.leftup = self.p0 + left_up
        self.leftdown = self.p0
        self.rightup = self.p0 + right_up
        self.rightdown = self.p0
        ...
        if t < 0.25 * cycle_len:
            ...
            pd_leg = self.p0 + (self.leftup - self.p0) * s0
            ...
            pd_leg = self.p0 + (self.rightup - self.p0) * s0
        ...
        theta1_FL = - atan2(self.l_calf*sin(theta2_FL), self.l_thigh + self.l_calf*cos(theta2_FL))
        ...
        theta1_FR = - atan2(self.l_calf*sin(theta2_FR), self.l_thigh + self.l_calf*cos(theta2_FR))
        ...
        theta1_RL = - atan2(self.l_calf*sin(theta2_RL), self.l_thigh + self.l_calf*cos(theta2_RL))
        ...
        theta1_RR = - atan2(self.l_calf*sin(theta2_RR), self.l_thigh + self.l_calf*cos(theta2_RR))
